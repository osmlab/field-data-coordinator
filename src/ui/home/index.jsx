        ...
        <section className='page__header row'>
          ...
          <div className='header__content'>
            <div className='header__card'>
              ...
              <a className='card__link primary--link'>Create a Survey</a>
            </div>
            <div className='header__card'>
              <div className='card__image'></div>
              ...
              <a className='card__link primary--link'>Download the App</a>
            </div>
            <div className='header__card'>
              <div className='card__image'></div>
              ...
              <a className='card__link primary--link'>View Collected Data</a>
            </div>
            <div className='header__card'>
              <div className='card__image'></div>
